        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a href="#hasillakkegpen" data-toggle="modal"><i class="fa fa-desktop" aria-hidden="true"></i> Peta Wilayah Penkum</a>
              </li>
              <li>
                <a href="#hasillakkegluh" data-toggle="modal"><i class="fa fa-desktop" aria-hidden="true"></i> Peta Wilayah Luhkum</a>
              </li>
            </ul>
          </li>
        </ul>
